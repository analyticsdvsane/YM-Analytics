package com.yuktamedia.analytics.internal;
...
public class Utils {
    public static final String THREAD_PREFIX = "Analytics-";
    ...
    public static SharedPreferences getAnalyticsSharedPreferences(Context context, String tag) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (nw != null) {
                ...
                if (actNw != null && actNw.hasTransport(NetworkCapabilities.TRANSPORT_WIFI)) {
                    return true;
                } else return actNw != null && actNw.hasTransport(NetworkCapabilities.TRANSPORT_CELLULAR);
            } else {
                return false;
            }
        } else {
    ...
    /**
     * A {@link ThreadPoolExecutor} implementation by {@link com.yuktamedia.analytics.Analytics}
